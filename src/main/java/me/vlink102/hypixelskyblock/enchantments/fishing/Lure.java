...
public class Lure extends SBEnchantment {
    ...
    public List<String> getFullDescription() {
        ...
        description.add(ChatColor.translateAlternateColorCodes('&', "&7takes to catch something by &a" + SBUtils.round(Statistic.toPercentage(getMaximumCatchTimeDepletionModifier()), 2) + "%&7."));
