...
public class Hecatomb extends SBEnchantment {
    ...
    public List<String> getDescription() {
        ...
        description.add(ChatColor.translateAlternateColorCodes('&', "&7Gain &a+" + Statistic.toPercentage(getCatacombsXPModifier()) + "% &cCatacombs &7XP &"));
        description.add(ChatColor.translateAlternateColorCodes('&', "&a+" + Statistic.toPercentage(getClassXPModifier()) + "% &3Class &7XP, doubled on &bS+ &7runs."));
        description.add(ChatColor.translateAlternateColorCodes('&', "&7Grants &c+" + getHealthAdditive() + "❤ &7per &610 &cCatacombs &7levels."));
        description.add("");
